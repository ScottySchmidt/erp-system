  ...
  return (
    <main className="page-wrap px-4 pb-8 pt-14">
      <section className="island-shell rounded-[2rem] px-6 py-10 sm:px-10 sm:py-14">
        ...
        <h1 className="mb-5 text-4xl font-bold text-[var(--sea-ink)]">
        ...
        <div className="mb-6 flex gap-3">
          <button
            ...
            className="rounded-full border border-[rgba(50,143,151,0.3)] bg-[rgba(79,184,178,0.14)] px-5 py-2.5 text-sm font-semibold text-[var(--lagoon-deep)] transition hover:-translate-y-0.5"
          >
            Run Database Test
          </button>
